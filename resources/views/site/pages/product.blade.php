                    ...
                    <div class="card">
                        <div class="row no-gutters">
                            ...
                            <aside class="col-sm-7">
                                <article class="p-5">
                                    <h3 class="title mb-3">{{ app()->getLocale() == 'ar' && $product->name_ar ? $product->name_ar : $product->name }}
                                        <br>
                                            ...
                                            <div class="col-sm-12">
                                                <dl class="dlist-inline">
                                                    @foreach ($attributes as $attribute)
                                                        ...
                                                        @if ($attributeCheck)
                                                            <dt>{{ app()->getLocale() == 'ar' && $attribute->name_ar ? $attribute->name_ar : $attribute->name }}: </dt>
                                                            <dd>
                                                                <select id="attribute"
